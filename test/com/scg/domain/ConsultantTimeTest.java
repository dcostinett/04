...
public class ConsultantTimeTest {
    ...
    private static ClientAccount account;
    ...
    public void setUp() throws Exception {
        ...
        now = cal.getTime();
        account = new ClientAccount("MyTestClient", new Name("Last", "First"));
        consultantTime = new ConsultantTime(now, account, Skill.PROJECT_MANAGER, 100);
    }
